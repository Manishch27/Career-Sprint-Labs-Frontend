...
export function MobileNav() {
  ...
  const handleSearch = (query: string) => {
    ...
    const results = [...categories, ...quickLinks].filter((item) =>
          ...
          {searchResults.length === 0 && (
            <div className="p-4 space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 px-2">Universities</h3>
              ...
              {/* Quick Links */}
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 px-2">Popular Courses</h3>
              ...
              {/* Contact Information */}
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 px-2">Contact Us</h3>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <Button variant="outline" className="w-full">
                  ...
                  <a href="tel:+919027717308" className="text-white">Call Now</a>
                </Button>
                <Button className="w-full">
                  <Mail className="mr-2 h-4 w-4 text-white" />
                  <a href="mailto:info@careersaathi.com" className="text-white">Email Us</a>
                </Button>
              </div>
            </div>
          )}
